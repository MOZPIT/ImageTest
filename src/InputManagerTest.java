...
/*
 * InputManagerTest test the InputManager with a simple run-and-jump mechanism. The player moves and jumps
 * using the arrow keys and the spacebar. <p>Also, InputManagerTest demonstrates pausing a game by not
 * updating the game elements if the game is paused. 
 */
public class InputManagerTest extends GameCore1 {
	...
	public void update(long elapsedTime) {
		//check input that can happen whether paused or not checkSystemInput();
		checkSystemInput();
	...
	/*
	 * Checks input from GameActions that can be pressed only when game is not paused.
	 */
