...
/* 
 * Extends the InputManagerTest demo and adds Swing buttons for pause, config and quit.
 */
public class MenuTest extends InputManagerTest implements ActionListener{
	...
	public void draw(Graphics2D g) {
		...
		//the layered pane contains thigns like popups (tooltips, popup menus) and the content pane.
	 ...
	 * "default" look (translucent) and a 
	 * "pressed" look (moved down and to the right). <p>The button doesn't use 
	 * Swing's look-and-feel and instead just uses the image.
	 */
