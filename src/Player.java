/*
 * The Player class extends the Sprite class to add states (STATE_NORMAL or STATE_JUMPING) and gravity.
 */
public class Player extends Sprite{
	...
	/*
	 * Sets the location of "floor", where the Player starts and lands after jumping.
	 */
	...
	/*
	 * Updates the player's position and animation. Also, sets the Player's state to NORMAL if a jumping Player landed on the floor.
	 */
